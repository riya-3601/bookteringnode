...
var login={
    checkadminuser:function(data,callback){
        return db1.query('select * from customer_tbl where customer_emailid=? and customer_password=? and customer_type=1',[data.login_username,data.login_password],callback);  
      },
