...
var bookreview={
    ...
    getBookreviewByBookbarterId:function(bookbarter_id,callback){
        return db.query('select br.*,bb.*,cust.*,cat.* from bookreview_tbl br,bookforbarter_tbl bb,customer_tbl cust,category_tbl cat where bb.bookbarter_id=br.fk_bookbarter_id and cust.customer_id=br.fk_customer_id and cat.category_id=br.fk_category_id and bb.bookbarter_id=?',[bookbarter_id],callback);
    }
