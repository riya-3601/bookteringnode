...
var shelfcart={
    getcart:function(id,callback){
        return db.query('select sc.*,bfs.* from shelfcart_tbl sc,bookforsale_tbl bfs where bfs.book_id=sc.fk_book_id and shelfcart_status="in cart" and sc.fk_customer_id=?',[id],callback);
    },
